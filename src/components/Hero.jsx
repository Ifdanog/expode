...
const Hero = () => {
  return (
    <>
      <div className="absolute inset-0 z-0 bg-[#0057ff]">
      ...
      <div className="relative w-[80%] mx-auto h-screen overflow-hidden">
        <div className="relative z-1 h-full">
          <div className="flex flex-col justify-center items-center h-full relative z-1 text-white text-center md:text-left">
